...
def save_all_geotiff():
    ...
    geotiff_fn = os.path.basename(dirname) + "_bs%02d_sr%02d_correlation.tif" % (
        block_size,
        search_radius,
    )
    logging.info("Save geotiff to %s" % (geotiff_fn))
...
if __name__ == "__main__":
    ...
    csv_fname = "/raid2-gpu2/bodo/LANDSAT/P232R077/corr_dates_sd1_cc5"
    ...
    for i in range(len(date_pairs)):
        ...
        print(
            "run_fullscene_blockmatching.py %s %s %d $d"
