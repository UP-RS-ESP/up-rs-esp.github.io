...
for reffile in $refdir/*os??_*.npy; do
	...
	tilenr=${reffile_basename:49:2}
	os=${reffile_basename:44:4}
	...
	logfile=$basedir/log/${refyear}_${secyear}_${os}_${tilenr}_bs${blocksize}_sr${searchradius}.bash.log
	errfile=$basedir/log/${refyear}_${secyear}_${os}_${tilenr}_bs${blocksize}_sr${searchradius}.bash.err
	...
	submit_slurm_block_matching_ids=$(
		sbatch -G=1 --mem-per-gpu=2G --partition=gpu_all --cpus-per-gpu=2 --time=24:00:00 --output=$logfile --error=$errfile $file2process
	)
