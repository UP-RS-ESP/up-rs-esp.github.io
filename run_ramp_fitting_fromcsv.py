...
if __name__ == "__main__":
    ...
    u_stats_df.to_csv(csv_fname + "_u_stats.csv")
    u_percentiles_fn = csv_fname + "_u_percentiles.csv"
    np.savetxt(u_percentiles_fn, u_percentiles, delimiter=",")
    du_percentiles_fn = csv_fname + "_p1_du_percentiles.csv"
    ...
    v_stats_df.to_csv(csv_fname + "_v_stats.csv")
    v_percentiles_fn = csv_fname + "_v_percentiles.csv"
    np.savetxt(v_percentiles_fn, v_percentiles, delimiter=",")
    dv_percentiles_fn = csv_fname + "_p1_dv_percentiles.csv"
