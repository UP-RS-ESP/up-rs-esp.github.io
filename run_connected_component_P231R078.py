...
def load_dem_aspect_slope_files(dem_fname):
    ...
    #!gdaldem hillshade COP15_DEM_NW_ARGENTINA_UTM20_P231R078.tif COP15_DEM_NW_ARGENTINA_UTM20_P231R078_hs.tif -co COMPRESS=DEFLATE -co ZLEVEL=9
...
def plot_profiles(
    ...
    profile_pngfn = "P231_to_P001R078_CORR_os05_bs61_sr06_ms05_profile.png"
    fig, ax = plt.subplots(
        nrows=2,
        ncols=1,
        figsize=(16, 9),
    ...
    plt.close()
    profile_pngfn = "P231_to_P001R078_CORR_os05_bs61_sr06_ms05_3profiles.png"
    fig, ax = plt.subplots(
        nrows=3,
        ncols=1,
        figsize=(16, 9),
...
def plot_3profiles_overview():
    pngfn = "P231_to_P001R078_CORR_os05_bs61_sr06_ms05_overview.png"
    skipstep = 10
...
def plot_histogram():
    ...
    # plot histgram
    #
    hist_pngfn = "P231_to_P001R078_CORR_os05_bs61_sr06_ms05_histogram.png"
    startx = 0
...
def plot_CC_profiles():
    ccprofile_pngfn = "P231_to_P001R078_CORR_os05_bs61_sr06_ms05_CC1e4m4_E_to_W.png"
    fig, ax = plt.subplots(
        nrows=2,
        ncols=1,
        figsize=(16, 9),
    ...
    plt.close()
    #
    ccprofile_pngfn = "P231_to_P001R078_CORR_os05_bs61_sr06_ms05_CC1e5m2_E_to_W.png"
    fig, ax = plt.subplots(
        nrows=2,
        ncols=1,
        figsize=(16, 9),
    ...
    plt.close()
    #
    ccprofile_pngfn = "P231_to_P001R078_CORR_os05_bs61_sr06_ms05_CC1e6m2_E_to_W.png"
    fig, ax = plt.subplots(
        nrows=2,
        ncols=1,
        figsize=(16, 9),
...
if __name__ == "__main__":
    ...
    dem_fname = "COP15_DEM_NW_ARGENTINA_UTM20_P231R078.tif"
    dem, dem_gt, dem_proj, dem_epsg, dem_aspect, dem_slope, dem_hs = (
        load_dem_aspect_slope_files(dem_fname)
    )
    displacement_fn = "CORR_os05_bs91_sr06_ms05_corr_dates_sd1_cc20_A_median_velocity_magnitude_my.tif"
    ...
    # displacement_variance_fn = "/home/bodo/Dropbox/foo/P231_to_P001R078_CORR_os05_bs61_sr06_ms05_variance_magnitude_my.tif"
    ...
    nre_fn = "CORR_os05_bs91_sr06_ms05_corr_dates_sd1_cc20_A_nre_velocity.tif"
    ...
    plot_3panel_overview(
        ...
        nre[::10, ::10],
        "CORR_os05_bs91_sr06_ms05_corr_dates_sd1_cc20_A_median_velocity_magnitude_my_3panel_overview.png",
    )
    ...
    displacement_stats_bbox_gdf.to_file(
        "CORR_os05_bs91_sr06_ms05_corr_dates_sd1_cc20_A_median_velocity_magnitude_my_cc1e4m2_bbox.gpkg"
    )
    ...
    displacement_stats_gdf.to_file(
        "CORR_os05_bs91_sr06_ms05_corr_dates_sd1_cc20_A_median_velocity_magnitude_my_cc1e4m2.gpkg"
    )
