---
title: "**Internship 1 - Report**"
format:
  html:
    toc: true
    html-math-method: katex
    embed-resources: true
    bibliography: Internship - Report - Bibliography.bib
---
...
![](Pictures%20Report/untitled_3_crop.png){fig-align="center"}

## **1. Introduction**

High quality photogrammetry models are an important scientific tool for many research fields, including the geosciences. Especially the quality of the geometry is crucial for follow-up analysis of the recorded objects. Processing steps such as roughness estimation, volume calculation, curvature analysis, 3D curve fitting, or fusion with lidar products expect a "correct" model of the real world geometries. Since photogrammetry relies on multiple, complex processing steps, it is heavily influenced by user experience. In addition, the varying camera hardware and estimated parameters are optimized in one bundle adjustment step that is prone to errors in the final product. One common error is the so called "doming error" that shows up as a global warping of the recorded objects. This is especially visible in ground scans ether from handheld or drone images that observe a flat area with high vertical extent. Minimizing this error is desired for virtual models. The content of this report is analyzing the characteristic of the doming error, to find error sources, and suggest mitigation strategies.
...
![3D reconstruction of the test area](Pictures%20Report/S1H%20OVerview_area_white.png){fig-align="center"}
...
![Image Aquisition for Lens/Camera Calibration](Pictures%20Report/IMG_3362.JPEG){fig-align="center" width="40%"}
...
![Charuco target example image](Pictures%20Report/Charuco%20example.png){fig-align="center" width="80%"}
...
![Setup with different acquisition distances and angles](Pictures%20Report/Setup_overview_v2.svg){fig-align="center" width="80%"}
...
![Processing steps Metashape](Pictures%20Report/02%20Mermaid%20Chart%20-%20Create%20complex,%20visual%20diagrams%20with%20text.-2025-12-16-204402.svg){fig-align="center" width="60%"}
...
![Overview local noise measurements](Pictures%20Report/Targets%20overiew.png){fig-align="center" width="70%"}
...
![](Pictures%20Report/Camera%20Calibration%20Figures\Calibration_A7R5_v2_vs_A7R5_internal_selfcalibration_3_panel_func1.svg){fig-align="center" width="95%"}

![Comparison of camera calibration for A7R5. CalibIO calibration on the left, Metashape calibration middle, difference at the right](Pictures%20Report/Camera%20Calibration%20Figures\Calibration_A7R5_v2_vs_A7R5_precalibration_3_panel_func1.svg){fig-align="center" width="95%"}
...
![](Pictures%20Report/Camera%20Calibration%20Figures\Calibration_A6000_v2_vs_A6000_internal_selfcalibration_3_panel_func1.svg){fig-align="center" width="95%"}

![Comparison of camera calibration for A6000. CalibIO calibration on the left, Metashape calibration middle, difference at the right](Pictures%20Report/Camera%20Calibration%20Figures\Calibration_A6000_v2_vs_A6000_precalibration_3_panel_func1.svg){fig-align="center" width="95%"}
...
![](Pictures%20Report/Camera%20Calibration%20Figures\Calibration_S1H_v2_vs_S1H_internal_selfcalibration_3_panel_func1.svg){fig-align="center" width="95%"}

![Comparison of camera calibration for S1H. CalibIO calibration on the left, Metashape calibration middle, difference at the right](Pictures%20Report/Camera%20Calibration%20Figures\Calibration_S1H_v2_vs_S1H_precalibration_3_panel_func1.svg){fig-align="center" width="95%"}
...
![Height model of A7R5 with fixed precalibration](Pictures%20Report/A7R5_DenseCloud_medium_milfFiltering_precalibration_fixedCalib_p12changed_cropped.png){fig-align="center" width="70%"}
