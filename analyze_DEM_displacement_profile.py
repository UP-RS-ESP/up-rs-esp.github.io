...
def load_dem_aspect_slope_files(dem_fname):
    ...
    aspect_fname_lst = glob.glob(
        os.path.join(
            dem_dir, "P231_to_P001R077_COP15_DEM_NW_ARGENTINA_UTM19_aspect.tif"
        )
    )
    ...
    slope_fname_lst = glob.glob(
        os.path.join(dem_dir, "P231_to_P001R077_COP15_DEM_NW_ARGENTINA_UTM19_slope.tif")
    )
    ...
    hs_fname_lst = glob.glob(
        os.path.join(dem_dir, "P231_to_P001R077_COP15_DEM_NW_ARGENTINA_UTM19_hs.tif")
    )
...
if __name__ == "__main__":
    ...
    dem_fname = (
        "/home/bodo/Dropbox/foo/P231_to_P001R077_COP15_DEM_NW_ARGENTINA_UTM19.tif"
    )
    dem, dem_gt, dem_proj, dem_epsg, dem_aspect, dem_slope, dem_hs = (
        load_dem_aspect_slope_files(dem_fname)
    )
    displacement_fn = "/home/bodo/Dropbox/foo/P231_to_P001R077_CORR_os05_bs61_sr06_ms05_median_velocity_magnitude_my.tif"
    ...
    nre_fn = "/home/bodo/Dropbox/foo/P231_to_P001R077_CORR_os05_bs91_sr06_ms05_nre_velocity.tif"
    ...
    displacement_my = gaussian_filter_nan(displacement_my, sigma=2, truncate=4)
    ...
    plot_3panel_overview(
        ...
        nre[::10, ::10],
        "P231_to_P001R077_CORR_os05_bs61_sr06_ms05_3panel_overview.png",
    )
    ...
    displacement_stats_bbox_gdf = gpd.GeoDataFrame(
        displacement_stats_df, geometry=bbox_polygon_list, crs="EPSG:32619"
    )
    displacement_stats_bbox_gdf.to_file(
        "P231_to_P001R077_CORR_os05_bs61_sr06_ms05_cc1e4m2_bbox.gpkg"
    )
    ...
    displacement_stats_gdf.to_file(
        "P231_to_P001R077_CORR_os05_bs61_sr06_ms05_cc1e4m2.gpkg"
    )
